...
### Changed
- mod_PIDAdmin.bas + mod_PerformanceBaseline.bas (FP-035 / TR-05): Performance-/UX-Review abgeschlossen — Top-3-Reibung und Folgemassnahmen in `docs/PERFORMANCE_BASELINE.md`. `PID_FullSystemRefresh` verlangt jetzt Bestaetigung mit Klartext (nur nach VBA-Import/Formel-Restore/grossen Layout-Aenderungen noetig; Alltag = dirty/auto). Admin-Info und Baseline-Footer ergaenzt um MANU-Checkliste / Tester-Frage. Kein CopyData-/Perf-Refactor.
