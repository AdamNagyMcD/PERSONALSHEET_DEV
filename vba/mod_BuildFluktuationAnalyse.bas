...
NextDataRow:
    ...
    With analyseWs
        ...
        PID_FlRemovePdfExportButton analyseWs
...
Public Sub PID_RemoveFluktuationPdfExportButtonIfNeeded()
    ...
    PID_FlRemovePdfExportButton ws

SafeExit:
End Sub


Private Sub PID_FlRemovePdfExportButton(ByVal ws As Worksheet)
    Dim shp As Shape
    ...
    For shapeIndex = ws.Shapes.Count To 1 Step -1
        ...
        If shp.Name = PID_FL_LEGACY_PDF_BUTTON_NAME Then shp.Delete
    Next shapeIndex
    Err.Clear
End Sub
